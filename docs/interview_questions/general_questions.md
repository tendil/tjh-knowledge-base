...
- [1. Які знаєте Web elements](#1-web-elements)
- [2. Для чого необхідні інструменти розробника в браузері (Chrome DevTools) і як вони допомагають у тестуванні](#2-chrome-devtools)
- [3. Що таке кеш](#3)
- [4. Що таке сесія](#4)
- [5. Навіщо потрібні cookies](#5-cookies)
- [6. iFrame і як з ним працювати в Selenium](#6-iframe-selenium)
- [7. Що таке HTML/CSS/JavaScript](#7-htmlcssjavascript)
- [8. Яку структуру має веб-сторінка](#8-)
- [9. Навіщо чистити кеш](#9)
- [10. Що таке AJAX](#10-ajax)
- [11. Що таке ADB](#11-adb)
- [12. Які є HTTP-методи](#12-http-)
- [13. Розшифрування CRUD](#13-crud)
- [14. Як відбувається шифрування](#14)
- [15. Які способи взаємодії з API існують? У чому різниця між ними](#15-api)
- [16. Як можна протестувати API, що там потрібно перевіряти](#16-api)
- [17. Формати передачі даних](#17)
- [18. Відмінності між XML та JSON](#18-xml-json)
- [19. Клієнт-серверна архітектура](#19-)
- [20. Для чого потрібні TestNG, JUnit](#20-testng-junit)
- [21. Які інструкції використовуються в TestNG, JUnit](#21-testng-junit)
- [22. Які assertions є в TestNG, JUnit](#22-assertions-testng-junit)
- [23. Як виконувати тести паралельно TestNG, JUnit](#23-testng-junit)
- [24. 2 способи, що дозволяють автоматизувати капчу](#24-2)
- [25. Що таке Selenium Grid](#25-selenium-grid)
- [26. Драйвер браузера](#26)
- [27. Які види локаторів сторінки існують? Які їх переваги та недоліки](#27)
