## **10. Запитання для співбесіди на тему Testing theory (Теорія тестування)**

---

## 10. Теорія тестування
[Back to top ⬆️](#10-testing-theory)
...
- [6. Які техніки проектування тестів ви знаєте](#6-які-техніки-тест-дизайну-знаєте)
...
- [9. Що таке Regression і Confirmation тестування, в чому різниця між ними](#9)
...
- [53. Тестування API? Інструменти](#53-api-інструменти)
...
- [58. Electron? Як використовувати Selenium для тестування програм на його основ](#58-electron)
...
- [66. Чи може сервер відправити код 400, якщо проблема на його стороні](#66)
...
- [92. End-to-End тест](#92-end-to-end-тест)
